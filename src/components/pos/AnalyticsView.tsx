...
export const AnalyticsView: React.FC = () => {
  ...
  const totalGrossRevenue = posOrders.reduce((acc, o) => acc + o.total, 3180.45);

  const hourlyData = [
    { hour: "10 AM", revenue: 240, orders: 12, height: "30%" },
    { hour: "11 AM", revenue: 420, orders: 18, height: "55%" },
    { hour: "12 PM", revenue: 780, orders: 36, height: "95%" },
    { hour: "01 PM", revenue: 860, orders: 42, height: "100%" },
    { hour: "02 PM", revenue: 510, orders: 24, height: "65%" },
    { hour: "03 PM", revenue: 320, orders: 15, height: "40%" },
    { hour: "04 PM", revenue: 290, orders: 14, height: "35%" },
    { hour: "05 PM", revenue: 480, orders: 22, height: "60%" },
    { hour: "06 PM", revenue: 720, orders: 34, height: "85%" },
    { hour: "07 PM", revenue: 940, orders: 48, height: "100%" },
    { hour: "08 PM", revenue: 890, orders: 44, height: "92%" },
    { hour: "09 PM", revenue: 410, orders: 19, height: "50%" },
  ];

  const categoryShare = [
    { name: "Burgers & Combos", percentage: 42, color: "bg-[#FF6B00]", amount: "$1,440" },
    { name: "Artisan Pizzas", percentage: 28, color: "bg-amber-500", amount: "$960" },
    { name: "Pastas & Bowls", percentage: 18, color: "bg-orange-400", amount: "$617" },
    { name: "Beverages & Desserts", percentage: 12, color: "bg-rose-400", amount: "$411" },
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-3xl p-5 border border-gray-100 shadow-sm">
          ...
          <div className="text-2xl font-black text-gray-900 mb-1">
            ${(totalGrossRevenue / totalOrdersCount).toFixed(2)}
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm flex flex-col justify-between">
          ...
          <div className="mt-6 pt-4 border-t border-gray-100 text-xs text-gray-500 flex items-center justify-between">
            ...
            <span className="font-bold text-[#FF6B00]">Cheese burger ($5.59)</span>
          </div>
        </div>
      </div>
    </div>
